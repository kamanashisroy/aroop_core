...
#define opp_hash_otable_create(x,ar,ars,y,z,a,b) ({opp_hash_otable_create_and_profile(x,ar,ars,y,z,a,b, __FILE__, __LINE__, AROOP_MODULE_NAME);})
...
#define opp_hash_otable_destroy(x) opp_factory_destroy_and_remove_profile(&(x)->fac)
C_CAPSULE_END
